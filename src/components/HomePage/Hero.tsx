      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center sm:text-left">
            <Badge className="mb-4 bg-blue-100 text-blue-800 hover:bg-blue-100 mx-auto sm:mx-0">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-prose mx-auto sm:mx-0">
